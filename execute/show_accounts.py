...
def show_accounts(
    ...
    """
    Fetch and format account group information.
    ...
    Returns:
        str: Formatted account group information or a message indicating file creation.
    """
    show_command = ShowCommand(token)
    return show_command("account-groups", file_format, aid, write)